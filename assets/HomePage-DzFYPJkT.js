...
`,C=u.div`
  ...
  @media (min-width: ${({theme:e})=>e.breakpoints.mobileLarge}) {
    flex-direction: row;
    width: auto;
  }
`,w=u(t)`
...
`,E=e(),D=()=>(0,E.jsxs)(x,{children:[(0,E.jsxs)(S,{children:[(0,E.jsx)(`p`,{children:`Cook. Create. Share.`}),(0,E.jsx)(`h1`,{children:`Your Ultimate Digital Cookbook`}),(0,E.jsx)(`h2`,{children:`Store your favorite recipes, organize your collection and discover new dishes from the community.`}),(0,E.jsxs)(C,{children:[(0,E.jsxs)(w,{className:`green`,to:`/recipes`,children:[(0,E.jsx)(c,{size:32}),`Explore Recipes`]}),(0,E.jsxs)(w,{className:`orange`,to:`/my-recipes/new`,children:[(0,E.jsx)(l,{size:32}),`Create Recipe`]})]})]}),(0,E.jsx)(T,{children:(0,E.jsx)(`img`,{src:f,alt:`Cooking illustration`,loading:`lazy`})})]}),O=u.section`
  display: flex;
  flex-direction: column;
  gap: 48px;
  padding: 60px 0;
...
`,N=()=>(0,E.jsxs)(O,{children:[(0,E.jsxs)(k,{children:[(0,E.jsx)(`p`,{className:`sectionLabel`,children:`CULINARY WISDOM`}),(0,E.jsxs)(`h2`,{children:[`Inspiration From`,(0,E.jsx)(`span`,{children:` Culinary Legends`})]}),(0,E.jsx)(`p`,{className:`sectionDescription`,children:`Timeless thoughts from world-renowned chefs who shaped the way we think about food, creativity and cooking.`})]}),(0,E.jsx)(A,{children:(0,E.jsx)(j,{children:b.map(({name:e,quote:t,avatar:n,status:r},i)=>(0,E.jsx)(M,{children:(0,E.jsxs)(`figure`,{className:`chef-quote-card`,children:[(0,E.jsxs)(`blockquote`,{children:[(0,E.jsx)(`span`,{className:`quote-icon`,children:`“`}),(0,E.jsx)(`p`,{children:t}),(0,E.jsx)(`span`,{className:`quote-icon`})]}),(0,E.jsxs)(`figcaption`,{children:[(0,E.jsx)(`img`,{src:n,alt:e,className:`chef-avatar`,loading:`lazy`}),(0,E.jsxs)(`div`,{className:`chef-info`,children:[(0,E.jsxs)(`cite`,{className:`chef-name`,children:[`Chef `,e]}),(0,E.jsx)(`span`,{className:`chef-status`,children:r})]})]})]})},i))})})]}),P=u.section`
  display: flex;
  flex-direction: column;
  gap: 40px;
...
`,I=r(s(),1),L=()=>{let e=i(),t=o(ee),[r,a]=(0,I.useState)({title:``,emoji:``,tag:null}),s=(0,I.useMemo)(()=>r.tag?t.filter((e,t,n)=>n.findIndex(t=>t.recipe_name===e.recipe_name)===t&&e.tags?.includes(r.tag)).slice(0,3):[],[r.tag,t]);return(0,I.useEffect)(()=>{e(n()),(()=>{let e=new Date().getHours();a(e>6&&e<=11?{title:`Good morning! What’s for breakfast?`,emoji:`🍳`,tag:`breakfast`}:e>11&&e<=16?{title:`Hungry? Time for a hearty lunch!`,emoji:`🍲`,tag:`lunch`}:{title:`Cozy dinners for tonight`,emoji:`🌙`,tag:`dinner`})})()},[e]),!r.tag||!t?(0,E.jsx)(P,{children:(0,E.jsxs)(F,{children:[(0,E.jsx)(`h2`,{children:`Smart Recommendation`}),(0,E.jsx)(`h3`,{children:`Loading personalized recipes...`})]})}):(0,E.jsxs)(P,{children:[(0,E.jsxs)(F,{children:[(0,E.jsxs)(`div`,{className:`title-wrapper`,children:[(0,E.jsx)(`h2`,{children:`Smart Recommendation`}),(0,E.jsxs)(`h3`,{children:[r.title,(0,E.jsx)(`span`,{children:r.emoji})]})]}),(0,E.jsx)(`p`,{className:`subtitle`,children:`Tailored specifically to your current time of day`})]}),(0,E.jsx)(d,{recipes:s})]})},R=u.section`
  display: flex;
  flex-direction: column;
  row-gap: 20px;
...
`,V=()=>(0,E.jsxs)(R,{children:[(0,E.jsx)(`p`,{className:`sectionLabel`,children:`Why Yumly ?`}),(0,E.jsxs)(`h2`,{children:[`Everything You Need to Manage`,(0,E.jsx)(`span`,{children:` Your Recipes`})]}),(0,E.jsx)(`p`,{className:`sectionDescription`,children:`Create your own recipes, discover new dishes and keep everything organized in one personal cookbook.`}),(0,E.jsxs)(z,{children:[(0,E.jsxs)(B,{children:[(0,E.jsx)(`div`,{className:`badge success`,children:`Create`}),(0,E.jsx)(`img`,{src:_,alt:``,loading:`lazy`}),(0,E.jsx)(`h3`,{children:`Create Your Own Recipes`}),(0,E.jsx)(`p`,{children:`Add ingredients, cooking instructions and photos to build recipes exactly the way you like.`}),(0,E.jsx)(`span`,{className:`number`,children:`01`})]}),(0,E.jsxs)(B,{children:[(0,E.jsx)(`div`,{className:`badge warning`,children:`Discover`}),(0,E.jsx)(`img`,{src:v,alt:``,loading:`lazy`}),(0,E.jsx)(`h3`,{children:`Find Recipes Instantly`}),(0,E.jsx)(`p`,{children:`Search recipes by cuisine, cooking time and difficulty to discover your next favorite meal.`}),(0,E.jsx)(`span`,{className:`number`,children:`02`})]}),(0,E.jsxs)(B,{children:[(0,E.jsx)(`div`,{className:`badge success`,children:`Save`}),(0,E.jsx)(`img`,{src:y,alt:``,loading:`lazy`}),(0,E.jsx)(`h3`,{children:`Build Your Personal Cookbook`}),(0,E.jsx)(`p`,{children:`Store all your favorite recipes in one place and access them anytime from any device.`}),(0,E.jsx)(`span`,{className:`number`,children:`03`})]})]})]}),H=u.section`
  padding: 80px 0;
`,U=u.div`
  display: grid;
  grid-template-columns: 1fr;
...
`,Z=[p,m,h,g],Q=()=>(0,E.jsx)(H,{children:(0,E.jsxs)(U,{children:[(0,E.jsxs)(W,{children:[(0,E.jsx)(`h2`,{children:`Our Growing Family`}),(0,E.jsx)(`p`,{children:`Yumly is more than just a cookbook. It’s a global community of food lovers, home chefs, and culinary creators sharing their passion every day.`}),(0,E.jsxs)(G,{children:[(0,E.jsxs)(`div`,{className:`avatars`,children:[Z.map((e,t)=>(0,E.jsx)(K,{src:e,alt:`Community chef ${t+1}`},t)),(0,E.jsx)(`div`,{className:`avatar-plus`,children:`+9k`})]}),(0,E.jsxs)(q,{children:[`Join `,(0,E.jsx)(`strong`,{children:`9,400+ chefs`}),` who already share their culinary secrets!`]})]})]}),(0,E.jsxs)(J,{children:[(0,E.jsxs)(Y,{children:[(0,E.jsx)(X,{className:`green`,children:`🍳`}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`h3`,{children:`10,000+`}),(0,E.jsx)(`p`,{children:`Delicious Recipes Stored`})]})]}),(0,E.jsxs)(Y,{children:[(0,E.jsx)(X,{className:`orange`,children:`🔥`}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`h3`,{children:`Daily`}),(0,E.jsx)(`p`,{children:`Fresh Recipes Added`})]})]})]})]})}),$=u.section`
  padding: 80px 0px;
...
`,te=()=>{let e=a();return(0,E.jsx)($,{children:(0,E.jsxs)(`div`,{className:`content`,children:[(0,E.jsx)(`span`,{className:`emoji`,children:`✨`}),(0,E.jsx)(`p`,{className:`badge`,children:`READY TO COOK?`}),(0,E.jsx)(`h2`,{children:`Every Great Recipe Has a Story`}),(0,E.jsx)(`p`,{className:`description`,children:`Capture your culinary journey, save memorable dishes, and create a cookbook you'll return to again and again.`}),(0,E.jsx)(t,{to:`/my-recipes/new`,state:{from:e.pathname+e.search},className:`ctaButton`,children:`Get Started`})]})})},ne=()=>(0,E.jsxs)(`div`,{children:[(0,E.jsx)(D,{}),(0,E.jsx)(V,{}),(0,E.jsx)(L,{}),(0,E.jsx)(Q,{}),(0,E.jsx)(N,{}),(0,E.jsx)(te,{})]});export{ne as default};