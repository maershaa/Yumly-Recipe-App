...
`,T=e(),E=()=>(0,T.jsxs)(b,{children:[(0,T.jsxs)(x,{children:[(0,T.jsx)(`p`,{children:`Cook. Create. Share.`}),(0,T.jsx)(`h1`,{children:`Your Ultimate Digital Cookbook`}),(0,T.jsx)(`h2`,{children:`Store your favorite recipes, organize your collection and discover new dishes from the community.`}),(0,T.jsxs)(S,{children:[(0,T.jsxs)(C,{className:`green`,to:`/recipes`,children:[(0,T.jsx)(o,{size:32}),`Explore Recipes`]}),(0,T.jsxs)(C,{className:`orange`,to:`/my-recipes/new`,children:[(0,T.jsx)(a,{size:32}),`Create Recipe`]})]})]}),(0,T.jsx)(w,{children:(0,T.jsx)(`img`,{src:f,alt:`Cooking illustration`})})]}),D=c.section`
  display: flex;
  flex-direction: column;
...
`,M=()=>(0,T.jsxs)(D,{children:[(0,T.jsxs)(O,{children:[(0,T.jsx)(`p`,{className:`sectionLabel`,children:`CULINARY WISDOM`}),(0,T.jsxs)(`h2`,{children:[`Inspiration From`,(0,T.jsx)(`span`,{children:` Culinary Legends`})]}),(0,T.jsx)(`p`,{className:`sectionDescription`,children:`Timeless thoughts from world-renowned chefs who shaped the way we think about food, creativity and cooking.`})]}),(0,T.jsx)(k,{children:(0,T.jsx)(A,{children:y.map(({name:e,quote:t,avatar:n,status:r},i)=>(0,T.jsx)(j,{children:(0,T.jsxs)(`figure`,{className:`chef-quote-card`,children:[(0,T.jsxs)(`blockquote`,{children:[(0,T.jsx)(`span`,{className:`quote-icon`,children:`“`}),(0,T.jsx)(`p`,{children:t}),(0,T.jsx)(`span`,{className:`quote-icon`})]}),(0,T.jsxs)(`figcaption`,{children:[(0,T.jsx)(`img`,{src:n,alt:e,className:`chef-avatar`,loading:`lazy`}),(0,T.jsxs)(`div`,{className:`chef-info`,children:[(0,T.jsxs)(`cite`,{className:`chef-name`,children:[`Chef `,e]}),(0,T.jsx)(`span`,{className:`chef-status`,children:r})]})]})]})},i))})})]}),N=c.section`
  display: flex;
  flex-direction: column;
  gap: 40px;
...
`,F=n(s(),1),I=()=>{let e=t(),n=r(d),[a,o]=(0,F.useState)({title:``,emoji:``,tag:null}),s=(0,F.useMemo)(()=>a.tag?n.filter((e,t,n)=>n.findIndex(t=>t.recipe_name===e.recipe_name)===t&&e.tags?.includes(a.tag)).slice(0,3):[],[a.tag,n]);return(0,F.useEffect)(()=>{e(i()),(()=>{let e=new Date().getHours();o(e>6&&e<=11?{title:`Good morning! What’s for breakfast?`,emoji:`🍳`,tag:`breakfast`}:e>11&&e<=16?{title:`Hungry? Time for a hearty lunch!`,emoji:`🍲`,tag:`lunch`}:{title:`Cozy dinners for tonight`,emoji:`🌙`,tag:`dinner`})})()},[e]),!a.tag||!n?(0,T.jsx)(N,{children:(0,T.jsxs)(P,{children:[(0,T.jsx)(`h2`,{children:`Smart Recommendation`}),(0,T.jsx)(`h3`,{children:`Loading personalized recipes...`})]})}):(0,T.jsxs)(N,{children:[(0,T.jsxs)(P,{children:[(0,T.jsxs)(`div`,{className:`title-wrapper`,children:[(0,T.jsx)(`h2`,{children:`Smart Recommendation`}),(0,T.jsxs)(`h3`,{children:[a.title,(0,T.jsx)(`span`,{children:a.emoji})]})]}),(0,T.jsx)(`p`,{className:`subtitle`,children:`Tailored specifically to your current time of day`})]}),(0,T.jsx)(u,{recipes:s})]})},L=c.section`
  display: flex;
  flex-direction: column;
  row-gap: 20px;
...
`,B=()=>(0,T.jsxs)(L,{children:[(0,T.jsx)(`p`,{className:`sectionLabel`,children:`Why Yumly ?`}),(0,T.jsxs)(`h2`,{children:[`Everything You Need to Manage`,(0,T.jsx)(`span`,{children:` Your Recipes`})]}),(0,T.jsx)(`p`,{className:`sectionDescription`,children:`Create your own recipes, discover new dishes and keep everything organized in one personal cookbook.`}),(0,T.jsxs)(R,{children:[(0,T.jsxs)(z,{children:[(0,T.jsx)(`div`,{className:`badge success`,children:`Create`}),(0,T.jsx)(`img`,{src:g,alt:``}),(0,T.jsx)(`h3`,{children:`Create Your Own Recipes`}),(0,T.jsx)(`p`,{children:`Add ingredients, cooking instructions and photos to build recipes exactly the way you like.`}),(0,T.jsx)(`span`,{className:`number`,children:`01`})]}),(0,T.jsxs)(z,{children:[(0,T.jsx)(`div`,{className:`badge warning`,children:`Discover`}),(0,T.jsx)(`img`,{src:_,alt:``}),(0,T.jsx)(`h3`,{children:`Find Recipes Instantly`}),(0,T.jsx)(`p`,{children:`Search recipes by cuisine, cooking time and difficulty to discover your next favorite meal.`}),(0,T.jsx)(`span`,{className:`number`,children:`02`})]}),(0,T.jsxs)(z,{children:[(0,T.jsx)(`div`,{className:`badge success`,children:`Save`}),(0,T.jsx)(`img`,{src:v,alt:``}),(0,T.jsx)(`h3`,{children:`Build Your Personal Cookbook`}),(0,T.jsx)(`p`,{children:`Store all your favorite recipes in one place and access them anytime from any device.`}),(0,T.jsx)(`span`,{className:`number`,children:`03`})]})]})]}),V=c.section`
  padding: 80px 0;
`,H=c.div`
  display: grid;
  grid-template-columns: 1fr;
...
`,X=[p,ee,m,h],Z=()=>(0,T.jsx)(V,{children:(0,T.jsxs)(H,{children:[(0,T.jsxs)(U,{children:[(0,T.jsx)(`h2`,{children:`Our Growing Family`}),(0,T.jsx)(`p`,{children:`Yumly is more than just a cookbook. It’s a global community of food lovers, home chefs, and culinary creators sharing their passion every day.`}),(0,T.jsxs)(W,{children:[(0,T.jsxs)(`div`,{className:`avatars`,children:[X.map((e,t)=>(0,T.jsx)(G,{src:e,alt:`Community chef ${t+1}`},t)),(0,T.jsx)(`div`,{className:`avatar-plus`,children:`+9k`})]}),(0,T.jsxs)(K,{children:[`Join `,(0,T.jsx)(`strong`,{children:`9,400+ chefs`}),` who already share their culinary secrets!`]})]})]}),(0,T.jsxs)(q,{children:[(0,T.jsxs)(J,{children:[(0,T.jsx)(Y,{className:`green`,children:`🍳`}),(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`h3`,{children:`10,000+`}),(0,T.jsx)(`p`,{children:`Delicious Recipes Stored`})]})]}),(0,T.jsxs)(J,{children:[(0,T.jsx)(Y,{className:`orange`,children:`🔥`}),(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`h3`,{children:`Daily`}),(0,T.jsx)(`p`,{children:`Fresh Recipes Added`})]})]})]})]})}),Q=c.section`
  padding: 80px 0px;
...
`,$=()=>(0,T.jsx)(Q,{children:(0,T.jsxs)(`div`,{className:`content`,children:[(0,T.jsx)(`span`,{className:`emoji`,children:`✨`}),(0,T.jsx)(`p`,{className:`badge`,children:`READY TO COOK?`}),(0,T.jsx)(`h2`,{children:`Every Great Recipe Has a Story`}),(0,T.jsx)(`p`,{className:`description`,children:`Capture your culinary journey, save memorable dishes, and create a cookbook you'll return to again and again.`}),(0,T.jsx)(l,{to:`/my-recipes/new`,className:`ctaButton`,children:`Get Started`})]})}),te=()=>(0,T.jsxs)(`div`,{children:[(0,T.jsx)(E,{}),(0,T.jsx)(B,{}),(0,T.jsx)(I,{}),(0,T.jsx)(Z,{}),(0,T.jsx)(M,{}),(0,T.jsx)($,{})]});export{te as default};