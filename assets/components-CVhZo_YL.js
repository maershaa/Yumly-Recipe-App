...
`,R=({tags:e,setSelectedTag:t,selectedTag:n})=>(0,j.jsxs)(L,{children:[(0,j.jsx)(`li`,{className:n===`all`?`active`:``,children:(0,j.jsx)(`button`,{type:`button`,onClick:()=>t(`all`),children:`ALL`})},`all`),e.map(e=>(0,j.jsx)(`li`,{className:e===n?`active`:``,children:(0,j.jsx)(`button`,{type:`button`,onClick:()=>t(e),children:e.toUpperCase()})},e)).slice(1,8)]}),z=o.div`
  position: relative;
  display: flex;
  margin: 50px auto;
  width: 100%;
...
`,H=({type:e,name:t,placeholder:n,filterValue:r,setFilterValue:i})=>(0,j.jsxs)(z,{children:[(0,j.jsx)(B,{children:(0,j.jsx)(_,{size:18})}),(0,j.jsx)(V,{type:e,name:t,placeholder:n,value:r,onChange:e=>i(e.target.value)})]}),U=o.header`
  display: flex;
  align-items: center;
  justify-content: center;
`,W=({children:e,title:t})=>(0,j.jsxs)(U,{children:[(0,j.jsx)(u,{title:t}),e]}),G=o.form`
  display: flex;
  flex-direction: column;
  gap: 20px;
  margin: 32px auto;
...
`,de=({ingredients:e,onChange:n,addIngredient:r,removeIngredient:i,isIngredientsError:a})=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`h2`,{children:`Ingredients`}),e.map(({id:r,name:a,amount:o,unit:s})=>(0,j.jsxs)(ue,{children:[(0,j.jsxs)(`label`,{children:[(0,j.jsx)(`input`,{type:`text`,name:`name`,onChange:e=>n(r,e),value:a,placeholder:`Ingredient name`}),` `,(0,j.jsx)(`input`,{type:`number`,name:`amount`,min:1,onChange:e=>n(r,e),value:o,placeholder:`Amount`}),(0,j.jsx)(`select`,{name:`unit`,value:s,onChange:e=>n(r,e),children:ce.map(e=>(0,j.jsx)(`option`,{value:e,children:e},e))})]}),(0,j.jsx)(m,{variant:`delete`,onClick:()=>i(r),disabled:e.length<=3,children:(0,j.jsx)(t,{})})]},r)),a&&(0,j.jsx)(d,{errorMessage:a}),(0,j.jsxs)(m,{variant:`add`,onClick:r,children:[(0,j.jsx)(f,{}),`Add Ingredient`]})]}),fe=o.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
  width: 100%;
...
`,ge=({recipe_name:e,image_url:t,handleImageUpload:n,removeImage:r,isImgError:i,handleInputBlur:a,isTouched:o})=>{let{image_url:s}=o;return(0,j.jsxs)(j.Fragment,{children:[t?(0,j.jsxs)(he,{children:[(0,j.jsx)(`img`,{src:t,alt:e||`Recipe image`,loading:`lazy`}),(0,j.jsx)(m,{variant:`delete`,onClick:r,children:`Replace image`})]}):(0,j.jsx)(me,{children:(0,j.jsx)(`label`,{children:(0,j.jsx)(`input`,{type:`file`,accept:`.jpg, .png, .jpeg`,multiple:!1,onChange:n,onBlur:a,name:`image_url`})})}),i&&s&&(0,j.jsx)(d,{errorMessage:i})]})},_e=o.header`
  display: grid;
