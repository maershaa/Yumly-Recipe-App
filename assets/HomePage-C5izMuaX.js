...
`,T=n(),E=()=>(0,T.jsxs)(b,{children:[(0,T.jsxs)(x,{children:[(0,T.jsx)(`p`,{children:`Cook. Create. Share.`}),(0,T.jsx)(`h1`,{children:`Your Ultimate Digital Cookbook`}),(0,T.jsx)(`h2`,{children:`Store your favorite recipes, organize your collection and discover new dishes from the community.`}),(0,T.jsxs)(S,{children:[(0,T.jsxs)(C,{className:`green`,to:`/recipes`,children:[(0,T.jsx)(ee,{size:32}),`Explore Recipes`]}),(0,T.jsxs)(C,{className:`orange`,to:`/my-recipes/new`,children:[(0,T.jsx)(a,{size:32}),`Create Recipe`]})]})]}),(0,T.jsx)(w,{children:(0,T.jsx)(`img`,{src:d,alt:`Cooking illustration`})})]}),D=i.section`
  display: flex;
  flex-direction: column;
...
`,$=()=>(0,T.jsx)(Q,{children:(0,T.jsxs)(`div`,{className:`content`,children:[(0,T.jsx)(`span`,{className:`emoji`,children:`✨`}),(0,T.jsx)(`p`,{className:`badge`,children:`READY TO COOK?`}),(0,T.jsx)(`h2`,{children:`Every Great Recipe Has a Story`}),(0,T.jsx)(`p`,{className:`description`,children:`Capture your culinary journey, save memorable dishes, and create a cookbook you'll return to again and again.`}),(0,T.jsx)(o,{to:`/my-recipes/new`,className:`ctaButton`,children:`Get Started`})]})}),te=()=>(0,T.jsxs)(`div`,{children:[(0,T.jsx)(E,{}),(0,T.jsx)(B,{}),(0,T.jsx)(I,{}),(0,T.jsx)(Z,{}),(0,T.jsx)(M,{}),(0,T.jsx)($,{})]});export{te as default};