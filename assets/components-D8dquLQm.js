import{B as e,E as t,H as n,I as r,O as i,R as a,S as o,T as s,V as c,a as l,b as u,c as d,d as f,i as p,k as m,l as h,o as g,p as _,r as v,s as y,u as b,v as x,w as S,x as C,z as w}from"./index-kkUTDc8E.js";var T=n(c(),1),E=()=>(0,T.useCallback)(async(e,t)=>{try{let{data:n,error:i}=await r.from(`recipes`).insert({...e,user_id:t}).select();if(i)throw i;return console.log(`🚀 ~ Recipe successfully created:`,n),n}catch(e){throw console.error(`Error creating recipe:`,e.message),e}},[]),D=async(e,t)=>{try{let{data:n,error:i}=await r.storage.from(`recipeImage`).upload(e,t,{cacheControl:`3600`,upsert:!0});if(i)throw i;console.log(`🚀 ~ Upload success ~ data:`,n);let{data:a}=r.storage.from(`recipeImage`).getPublicUrl(e);return a.publicUrl}catch(e){throw console.error(`Error saving recipe:`,e.message),e}},O=()=>async(e,t,n)=>{let{data:i,error:a}=await r.from(`recipes`).update(e).eq(`id`,n).eq(`user_id`,t).select().single();if(a)throw console.error(`Error updating recipe:`,a.message),a;return i},k=async e=>{try{let{data:t,error:n}=await r.from(`recipes`).select(`*`).eq(`id`,e).single();if(n)throw n;return t}catch(e){throw console.error(`Error get recipe details:`,e.message),e}},A=async e=>{try{let{data:t,error:n}=await r.from(`recipes`).select(`*`).eq(`user_id`,e);if(n)throw n;return t}catch(e){throw console.error(`Error get user recipes:`,e.message),e}},ee=async e=>{console.log(`🚀 ~ deleteRecipe ~ recipeIdToDelete:`,e);try{let{data:t,error:n}=await r.from(`recipes`).delete().eq(`id`,e).select();if(n)throw n;return t}catch(e){throw console.log(`Error during deleted recipe`),e}},te=w.ul`
  display: grid;
...
`,H=({type:e,name:t,placeholder:n,filterValue:r,setFilterValue:i})=>(0,j.jsxs)(z,{children:[(0,j.jsx)(B,{children:(0,j.jsx)(u,{size:18})}),(0,j.jsx)(V,{type:e,name:t,placeholder:n,value:r,onChange:e=>i(e.target.value)})]}),U=w.header`
  display: flex;
  align-items: center;
  justify-content: center;
`,W=({children:e,title:t})=>(0,j.jsxs)(U,{children:[(0,j.jsx)(S,{title:t}),e]}),G=w.form`
  display: flex;
  flex-direction: column;
  gap: 20px;
  margin: 32px auto;
...
`;var Y=()=>({id:crypto.randomUUID(),name:``,amount:``,unit:`g`}),X=()=>({id:crypto.randomUUID(),text:``}),ae=({recipeForm:e,setRecipeForm:t,handleSubmit:n,currentUserId:r,isSubmitting:i,isFormValid:a,submitButtonText:s,validationErrors:c})=>{let[l,u]=(0,T.useState)({recipe_name:!1,description:!1,cuisine:!1,cooking_time:!1,servings:!1,image_url:!1,tips:!1}),d=e=>{let{name:n,value:r}=e.target;t(e=>({...e,[n]:r}))},f=async e=>{let n=e.target.files[0];if(!n)return;if(n.size>5*1024*1024){alert(`Слишком большой файл. Выберите файл до 5 мб`);return}let i=n.name.split(`.`).pop(),a=`${r}/${`${crypto.randomUUID()}.${i}`}`;try{let e=await D(a,n);t(t=>({...t,image_url:e}))}catch(e){console.error(`Ошибка при загрузке изображения:`,e)}},p=(e,n)=>{let{name:r,value:i}=n.target;t(t=>({...t,ingredients:t.ingredients.map(t=>t.id===e?{...t,[r]:i}:t)}))},m=(e,n)=>{let{value:r}=n.target;t(t=>({...t,instructions:t.instructions.map(t=>t.id===e?{...t,text:r}:t)}))},h=()=>{t(e=>({...e,ingredients:[...e.ingredients,Y()]}))},g=()=>{t(e=>({...e,instructions:[...e.instructions,X()]}))},_=e=>{t(t=>({...t,ingredients:t.ingredients.filter(t=>t.id!==e)}))},v=e=>{t(t=>({...t,instructions:t.instructions.filter(t=>t.id!==e)}))},y=()=>{t(e=>({...e,image_url:``}))},x=e=>{let t=e.currentTarget.name;u(e=>({...e,[t]:!0}))};return(0,j.jsxs)(G,{onSubmit:n,children:[(0,j.jsxs)(q,{children:[(0,j.jsx)(K,{children:(0,j.jsx)(le,{values:e,onChange:d,validationErrors:c,handleInputBlur:x,isTouched:l})}),(0,j.jsx)(K,{children:(0,j.jsx)(de,{ingredients:e.ingredients,onChange:p,addIngredient:h,removeIngredient:_,isIngredientsError:c.ingredients})})]}),(0,j.jsxs)(J,{children:[(0,j.jsx)(K,{children:(0,j.jsx)(pe,{instructions:e.instructions,onChange:m,addStep:g,removeStep:v,isStepsError:c.instructions})}),(0,j.jsx)(K,{children:(0,j.jsx)(ge,{recipe_name:e.recipe_name,image_url:e.image_url,handleImageUpload:f,removeImage:y,isImgError:c.image,handleInputBlur:x,isTouched:l})}),(0,j.jsxs)(o,{type:`submit`,variant:`submit`,disabled:!a||i,children:[(0,j.jsx)(b,{}),s]})]})]})},oe=w.div`
  display: flex;
  flex-direction: row;
  gap: 30px;
`;w.div`
...
`;var se=[`Ukrainian`,`American`,`British`,`Chinese`,`French`,`German`,`Greek`,`Indian`,`Italian`,`Japanese`,`Jewish`,`Korean`,`Mexican`,`Spanish`,`Thai`,`Vietnamese`],ce=[`g`,`kg`,`ml`,`l`,`pcs`,`tbsp`,`tsp`],le=({values:e,onChange:t,validationErrors:n,handleInputBlur:r,isTouched:i})=>{let{recipe_name:a,description:o,servings:s,cuisine:c,cooking_time:l,tips:u}=e,{recipe_name:d,description:p,servings:m,cuisine:h,cooking_time:g,tips:_}=n,{recipe_name:v,description:y,servings:b,cuisine:x,cooking_time:S,tips:C}=i,w=d&&v,T=p&&y,E=h&&x,D=g&&S,O=m&&b,k=_&&C;return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`h2`,{children:`Recipe Info`}),(0,j.jsxs)(`label`,{children:[`Title`,(0,j.jsx)(`input`,{type:`text`,name:`recipe_name`,onChange:t,onBlur:r,value:a,placeholder:`Recipe title`,className:w?`invalid`:``})]}),w&&(0,j.jsx)(f,{errorMessage:d}),(0,j.jsxs)(`label`,{children:[`Description`,(0,j.jsx)(`textarea`,{name:`description`,value:o,onChange:t,onBlur:r,placeholder:`Share the story behind this dish or what makes it special...`,className:T?`invalid`:``})]}),T&&(0,j.jsx)(f,{errorMessage:p}),(0,j.jsxs)(`label`,{children:[`Choose a Cuisine`,(0,j.jsxs)(`select`,{name:`cuisine`,value:c,onChange:t,onBlur:r,className:E?`invalid`:``,children:[(0,j.jsx)(`option`,{value:``,disabled:!0,children:`Cuisine...`}),se.map(e=>(0,j.jsx)(`option`,{value:e,children:e},e))]})]}),E&&(0,j.jsx)(f,{errorMessage:h}),(0,j.jsxs)(oe,{children:[(0,j.jsxs)(`label`,{children:[`Cooking Time`,(0,j.jsx)(`input`,{type:`number`,name:`cooking_time`,value:l,onChange:t,onBlur:r,placeholder:`Enter time in mins`,min:`1`,className:D?`invalid`:``})]}),(0,j.jsxs)(`label`,{children:[`Servings`,(0,j.jsx)(`input`,{type:`number`,name:`servings`,placeholder:`Number of servings`,value:s,onChange:t,onBlur:r,min:`1`,className:O?`invalid`:``})]})]}),D&&(0,j.jsx)(f,{errorMessage:g}),O&&(0,j.jsx)(f,{errorMessage:m}),(0,j.jsx)(`label`,{children:(0,j.jsx)(`textarea`,{name:`tips`,rows:3,onChange:t,onBlur:r,value:u,placeholder:`Share your kitchen secrets...`,className:k?`invalid`:``})}),k&&(0,j.jsx)(f,{errorMessage:_})]})},ue=w.div`
  display: flex;
  flex-direction: column;
  width: 100%;
  gap: 12px;
...
`,de=({ingredients:e,onChange:t,addIngredient:n,removeIngredient:r,isIngredientsError:i})=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`h2`,{children:`Ingredients`}),e.map(({id:n,name:i,amount:a,unit:s})=>(0,j.jsxs)(ue,{children:[(0,j.jsxs)(`label`,{children:[(0,j.jsx)(`input`,{type:`text`,name:`name`,onChange:e=>t(n,e),value:i,placeholder:`Ingredient name`}),` `,(0,j.jsx)(`input`,{type:`number`,name:`amount`,min:1,onChange:e=>t(n,e),value:a,placeholder:`Amount`}),(0,j.jsx)(`select`,{name:`unit`,value:s,onChange:e=>t(n,e),children:ce.map(e=>(0,j.jsx)(`option`,{value:e,children:e},e))})]}),(0,j.jsx)(o,{variant:`delete`,onClick:()=>r(n),disabled:e.length<=3,children:(0,j.jsx)(h,{})})]},n)),i&&(0,j.jsx)(f,{errorMessage:i}),(0,j.jsxs)(o,{variant:`add`,onClick:n,children:[(0,j.jsx)(g,{}),`Add Ingredient`]})]}),fe=w.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
  width: 100%;
...
`,pe=({instructions:e,onChange:t,addStep:n,removeStep:r,isStepsError:i})=>(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`h2`,{children:`Steps`}),e.map(({id:n,text:i},a)=>(0,j.jsxs)(fe,{children:[(0,j.jsxs)(`label`,{children:[(0,j.jsxs)(`span`,{className:`step-number`,children:[a+1,`.`]}),` `,(0,j.jsx)(`textarea`,{type:`text`,onChange:e=>t(n,e),value:i,placeholder:`Describe step ${a+1}`,rows:3})]}),(0,j.jsx)(o,{variant:`delete`,onClick:()=>r(n),disabled:e.length<=3,children:(0,j.jsx)(h,{})})]},n)),i&&(0,j.jsx)(f,{errorMessage:i}),(0,j.jsxs)(o,{variant:`add`,onClick:n,children:[(0,j.jsx)(g,{}),`Add Step`]})]}),me=w.div`
  position: relative;
...
`,ge=({recipe_name:e,image_url:t,handleImageUpload:n,removeImage:r,isImgError:i,handleInputBlur:a,isTouched:s})=>{let{image_url:c}=s;return(0,j.jsxs)(j.Fragment,{children:[t?(0,j.jsxs)(he,{children:[(0,j.jsx)(`img`,{src:t,alt:e||`Recipe image`,loading:`lazy`}),(0,j.jsx)(o,{variant:`delete`,onClick:r,children:`Replace image`})]}):(0,j.jsx)(me,{children:(0,j.jsx)(`label`,{children:(0,j.jsx)(`input`,{type:`file`,accept:`.jpg, .png, .jpeg`,multiple:!1,onChange:n,onBlur:a,name:`image_url`})})}),i&&c&&(0,j.jsx)(f,{errorMessage:i})]})},_e=w.header`
  display: grid;
