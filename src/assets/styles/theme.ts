...
// satisfies Theme — проверяет, что объект соответствует типу Theme,
// но сохраняет его собственную структуру и конкретные свойства.
// Поэтому TypeScript знает, например, что существует theme.colors.accent,
// и сразу подсветит ошибку при обращении к несуществующему свойству:
// theme.colors.accccent // ❌ такого свойства нет
// theme.colors.foo      // ❌ такого свойства нет
